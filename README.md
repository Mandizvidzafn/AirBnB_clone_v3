...
Weight: 2
Project to be done in teams of 2 people (your team: Nceba Mandizvidza, Ronnie Fwamba)
Project will start Apr 26, 2023 6:00 AM, must end by May 2, 2023 6:00 AM
...
All your modules should have documentation (python3 -c 'print(**import**("my*module").**doc**)')
...
GitHub repository: AirBnB_clone_v3
File: api/**init**.py, api/v1/**init**.py, api/v1/views/**init**.py, api/v1/views/index.py, api/v1/app.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/states.py, api/v1/views/**init**.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/cities.py, api/v1/views/**init**.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/amenities.py, api/v1/views/**init**.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/users.py, api/v1/views/**init**.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/places.py, api/v1/views/**init**.py
...
GitHub repository: AirBnB_clone_v3
File: api/v1/views/places_reviews.py, api/v1/views/**init**.py
